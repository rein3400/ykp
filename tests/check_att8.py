...
async function main() {
  ...
  for (let i = 1; i < rows.length; i++) {
    ...
    if (id === 'ATT-256') console.log('ATT-256 at row', i + 1);
  }
  // last 5 ids
...
sftp = ssh.open_sftp()
with sftp.file('/home/dev/ykp/ykp-hr-v1/check_att8.js', 'w') as f:
    f.write(NODE_SCRIPT)
sftp.close()

cmd = "export PATH=/home/dev/.nvm/versions/node/v20.20.2/bin:/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin; cd /home/dev/ykp/ykp-hr-v1 && node check_att8.js"
