/**
 * Signed session cookie (HS256 JWS). 24h, sameSite strict, httpOnly.
 * Cookie name: ykp_investor_session.
 */
...
const COOKIE_NAME = 'ykp_investor_session';
...
export interface SessionUser {
  userId: string; username: string; role: string; investorId?: string;
}
