...
import { safeEqual, providedCronSecret, isCronAuthorized } from '../src/lib/cron';
...
function reqWith(headers: Record<string, string>): Request {
  return new Request('http://localhost/api/warehouse/notify/daily-brief', { method: 'POST', headers });
}
