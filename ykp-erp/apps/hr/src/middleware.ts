 ...
 * - Rate limit: in-memory token bucket per IP. 30 req/min default; 5 req/min
 *   for sensitive endpoints (import, run, telegram-test). Multi-instance
 *   deploys would need Redis-backed bucket; documented in plan R6.
 */
