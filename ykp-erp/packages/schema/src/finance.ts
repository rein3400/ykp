...
export const finSupplierCost = finance.table("fin_supplier_cost", {
  ...
  notes: text("notes"),
  source: text("source"),
  // Revisi item 4 — cross-transaction linking to prevent double counting
  sourceModule: text("source_module"),
  sourceTransactionId: text("source_transaction_id"),
  paymentSource: text("payment_source"),
  linkedExpenseId: text("linked_expense_id"),
  linkedPettyCashId: text("linked_petty_cash_id"),
...
export const finPettyCash = finance.table("fin_petty_cash", {
  ...
  source: text("source"),
  // Revisi item 4 — cross-transaction linking
  sourceModule: text("source_module"),
  sourceTransactionId: text("source_transaction_id"),
  paymentSource: text("payment_source"),
  linkedExpenseId: text("linked_expense_id"),
  linkedSupplierInvoiceId: text("linked_supplier_invoice_id"),
  linkedPaymentId: text("linked_payment_id"),
  recordedAt: timestamp("recorded_at", { mode: "date" }).defaultNow().notNull(),
  recordedBy: text("recorded_by"),
  createdAt: timestamp("created_at", { mode: "date" }).defaultNow().notNull(),
