 ...
 *       ../../../../../_packages/engine/src generateFinDailySummary for each outlet on date.
 *
...
import { requireRole, can, applyOutletScope } from "../../../../../_packages/auth/src";
import { finDailySummary, masterOutlet } from "../../../../../_packages/schema/src";
import { getMasterDb, getFinanceDb } from "../../../../lib/server/db";
import { handler, ok, fail } from "../../../../lib/server/http";
import { logFinanceAudit } from "../../../../lib/server/audit";
import { generateFinDailySummary } from "../../../../../_packages/engine/src/index";
import { FinSummaryQuerySchema, FinSummaryRebuildSchema } from "../../../../lib/schemas";
