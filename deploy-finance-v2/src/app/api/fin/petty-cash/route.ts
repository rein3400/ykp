 ...
 * workflow via ../../../../../_packages/engine/src (DRAFT -> PENDING). Auto-creates a PENDING
 * audit chain when urgent.
 */
import { and, eq, gte, lte, desc } from "drizzle-orm";
import { Role } from "../../../../../_packages/config/src";
import { requireRole, can } from "../../../../../_packages/auth/src";
import { finPettyCash } from "../../../../../_packages/schema/src";
import { getMasterDb, getFinanceDb, type FinanceDb } from "../../../../lib/server/db";
import { handler, ok, fail } from "../../../../lib/server/http";
import { assertOutlet, assertPettyCashAccount, assertExpenseCategory } from "../../../../lib/server/refs";
import { logFinanceAudit } from "../../../../lib/server/audit";
import { financeDayId, transitionApproval } from "../../../../../_packages/engine/src/index";
import { FinPettyCashQuerySchema, FinPettyCashCreateSchema } from "../../../../lib/schemas";
