...
function seed(): Record<string, Record<string, string>[]> {
  ...
  return {
    // ── Master: brands (5) ──────────────────────────────────────
    [TAB.brands]: [
      { brand_id: 'BR-001', brand_name: 'Funkydak', brand_code: 'FKD', email: 'funkydak@gmail.com', status: 'active', created_at: t, updated_at: t, created_by: 'USR-001', updated_by: 'USR-001' },
      { brand_id: 'BR-002', brand_name: 'Sekarpizza', brand_code: 'SKP', email: 'sekarpizza@gmail.com', status: 'active', created_at: t, updated_at: t, created_by: 'USR-001', updated_by: 'USR-001' },
      { brand_id: 'BR-003', brand_name: 'Suburbuns', brand_code: 'SBN', email: 'suburbunsyk@gmail.com', status: 'active', created_at: t, updated_at: t, created_by: 'USR-001', updated_by: 'USR-001' },
      { brand_id: 'BR-004', brand_name: 'Laju Kopi', brand_code: 'LJK', email: '', status: 'active', created_at: t, updated_at: t, created_by: 'USR-001', updated_by: 'USR-001' },
      { brand_id: 'BR-005', brand_name: 'Uncle Masala', brand_code: 'UMS', email: '', status: 'active', created_at: t, updated_at: t, created_by: 'USR-001', updated_by: 'USR-001' }
    ],
    // ── Master: outlets (3) ─────────────────────────────────────
    [TAB.outlets]: [
    ...
    [TAB.auditLog]: [],
    // ── app_settings: SMTP config (password stored masked) ──────
    [TAB.appSettings]: [],
