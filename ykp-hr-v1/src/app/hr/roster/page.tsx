...
export default async function RosterPage() {
  ...
  const shiftById = new Map(shifts.map((s) => [s.shift_id, s.shift_name]));
        ...
        <div className='card lg:col-span-2'>
          ...
          <DataTable
            ...
            columns={[
              ...
              { key: 'shift', header: 'Shift', render: (r) => shiftById.get(r.shift_id) ?? r.shift_id },
              { key: 'status', header: 'Status', render: (r) => <StatusBadge status={r.roster_status || 'SCHEDULED'} /> },
